...
SRC = Path(
    ...
    r"ChatGPT_Image_Jul_8__2026__10_06_11_PM-c1ee12e3-4900-40f5-95dd-6d2843efb7e8.png"
)
...
def flood_background(mask: np.ndarray, arr: np.ndarray) -> np.ndarray:
    h, w = mask.shape
...
def main() -> None:
    ...
    out_path = ASSETS / "postcard-stamp-leo-full.png"
